...
public class VolumeInfo{
	...
	public String toString() {
		return "VolumeInfo [authors=" + authors + ", averageRating="
				+ averageRating + ", canonicalVolumeLink="
				+ canonicalVolumeLink + ", contentVersion=" + contentVersion
				+ ", description=" + description + ", imageLinks=" + imageLinks
				+ ", industryIdentifiers=" + industryIdentifiers
				+ ", infoLink=" + infoLink + ", language=" + language
				+ ", pageCount=" + pageCount + ", previewLink=" + previewLink
				+ ", printType=" + printType + ", publishedDate="
				+ publishedDate + ", ratingsCount=" + ratingsCount
